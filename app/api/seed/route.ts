...
// ── Benchmark catalog seed data ──────────────────────────────────────────

const BENCHMARK_CATALOG_DATA = [
  { id: "9fb65c5a-5ccf-4374-a264-9b03c9ac3bd1", code: "MSCI-WORLD-NR", name: "MSCI World Net Return", asset_class: "Aandelen", acId: ASSET_CLASSES.Aandelen, currency: "EUR", cost: 1000, provider: "MSCI" },
  { id: "b9ec8da5-5d7a-4ee0-a23e-9746ded5b43d", code: "MSCI-ACWI-NR", name: "MSCI ACWI Net Return", asset_class: "Aandelen", acId: ASSET_CLASSES.Aandelen, currency: "EUR", cost: 1200, provider: "MSCI" },
  { id: "7c8bd971-b05c-4141-9a27-7ee0d02137a5", code: "BLOOMBERG-EU-AGG", name: "Bloomberg Euro Aggregate", asset_class: "Obligaties", acId: ASSET_CLASSES.Obligaties, currency: "EUR", cost: 1000, provider: "Bloomberg" },
  { id: "9644a84d-59d6-40fa-aee9-062fbc1ef9fc", code: "ICE-BOFA-EU-CORP", name: "ICE BofA Euro Corporate", asset_class: "Obligaties", acId: ASSET_CLASSES.Obligaties, currency: "EUR", cost: 1000, provider: "ICE BofA" },
  { id: "a1b2c3d4-e5f6-7890-abcd-ef0123456780", code: "CUSTOM-ESG-NL", name: "Duurzame NL Benchmark", asset_class: "Aandelen", acId: ASSET_CLASSES.Aandelen, currency: "EUR", cost: 1500, provider: "rimes" },
  { id: "a1b2c3d4-e5f6-7890-abcd-ef0123456781", code: "RIMES-PRIVATE-EQ", name: "Rimes Private Equity Index", asset_class: "Alternatieven", acId: ASSET_CLASSES.Alternatieven, currency: "EUR", cost: 2000, provider: "rimes" },
  { id: "a1b2c3d4-e5f6-7890-abcd-ef0123456782", code: "EURO-GOVT-1-3Y", name: "Euro Government 1-3 Year", asset_class: "Obligaties", acId: ASSET_CLASSES.Obligaties, currency: "EUR", cost: 800, provider: "Bloomberg" },
  { id: "a1b2c3d4-e5f6-7890-abcd-ef0123456783", code: "GLOBAL-REIT-NR", name: "Global REIT Net Return", asset_class: "Vastgoed", acId: ASSET_CLASSES.Vastgoed, currency: "EUR", cost: 1500, provider: "MSCI" },
  { id: "9a1b2c3d-4e5f-6789-abcd-ef0123456784", code: "MSCI-EM-NR", name: "MSCI Emerging Markets Net Return", asset_class: "Aandelen", acId: ASSET_CLASSES.Aandelen, currency: "USD", cost: 1000, provider: "MSCI" },
  { id: "9a1b2c3d-4e5f-6789-abcd-ef0123456785", code: "BLOOMBERG-GL-AGG", name: "Bloomberg Global Aggregate", asset_class: "Obligaties", acId: ASSET_CLASSES.Obligaties, currency: "USD", cost: 1000, provider: "Bloomberg" },
  { id: "9a1b2c3d-4e5f-6789-abcd-ef0123456786", code: "HFRX-GL-HEDGE", name: "HFRX Global Hedge Fund Index", asset_class: "Alternatieven", acId: ASSET_CLASSES.Alternatieven, currency: "USD", cost: 2500, provider: "HFRX" },
  { id: "9a1b2c3d-4e5f-6789-abcd-ef0123456787", code: "S&P-500-NR", name: "S&P 500 Net Return", asset_class: "Aandelen", acId: ASSET_CLASSES.Aandelen, currency: "USD", cost: 1000, provider: "S&P" },
  { id: "a2b1c3d4-e5f6-7890-abcd-ef0123456788", code: "S&P-GSCI", name: "S&P GSCI Commodity Total Return", asset_class: "Grondstoffen", acId: ASSET_CLASSES.Grondstoffen, currency: "USD", cost: 1500, provider: "S&P" },
  { id: "a2b1c3d4-e5f6-7890-abcd-ef0123456789", code: "MSCI-WORLD-INFRA", name: "MSCI World Infrastructure Net Return", asset_class: "Infrastructuur", acId: ASSET_CLASSES.Infrastructuur, currency: "EUR", cost: 1400, provider: "MSCI" },
  { id: "a2b1c3d4-e5f6-7890-abcd-ef0123456790", code: "BLOOMBERG-GL-HY", name: "Bloomberg Global High Yield", asset_class: "Obligaties", acId: ASSET_CLASSES.Obligaties, currency: "USD", cost: 1800, provider: "Bloomberg" },
  { id: "a2b1c3d4-e5f6-7890-abcd-ef0123456791", code: "FTSE-EPRA-NAREIT-DEV", name: "FTSE EPRA Nareit Developed", asset_class: "Vastgoed", acId: ASSET_CLASSES.Vastgoed, currency: "EUR", cost: 1200, provider: "FTSE Russell" },
  { id: "a2b1c3d4-e5f6-7890-abcd-ef0123456792", code: "MSCI-WORLD-HEALTH", name: "MSCI World Health Care Net Return", asset_class: "Aandelen", acId: ASSET_CLASSES.Aandelen, currency: "EUR", cost: 1100, provider: "MSCI" },
];
...
const CLIENTS = [
  ...
  },
  {
    ...
    regelingType: "kapitaalovereenkomst",
    portfolios: [
      ["a0000000-0000-4000-a000-000000001001", "Rendementsportefeuille",  "LAN-RP", "Rendement", "EQUITIES", "AC WORLD", "EigenBeheer", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000001002", "Matchingportefeuille",    "LAN-MP", "Matching", "FIXED_INCOME", "GOVERNMENT BONDS", "EigenBeheer", "B", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000001003", "Opbouwportefeuille",      "LAN-OP", "Opbouw", "EQUITIES", "DEVELOPED MARKETS", "ExternA", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000001004", "Agrarische portefeuille", "LAN-AP", "Rendement", "REAL_ASSETS", "AGRICULTURE", "ExternB", "C", "SP_GSCI"],
      ["a0000000-0000-4000-a000-000000001005", "Duurzame portefeuille",   "LAN-DP", "Rendement", "EQUITIES", "DUURZAAM", "EigenBeheer", "C", "CUSTOM_ESG"],
      ["a0000000-0000-4000-a000-000000001006", "Krediet Europa",          "LAN-KE", "Rendement", "FIXED_INCOME", "CREDITS EUROPE", "ExternA", "B", "ICE_BOFA"],
      ["a0000000-0000-4000-a000-000000001007", "Private equity",          "LAN-PE", "Rendement", "ALTERNATIVES", "PRIVATE EQUITY", "ExternB", "A", "RIMES_PE"],
      ["a0000000-0000-4000-a000-000000001008", "Commoditeiten",           "LAN-CO", "Rendement", "REAL_ASSETS", "COMMODITIES", "ExternA", "C", "SP_GSCI"],
    ],
  },
  {
    ...
    regelingType: "premieovereenkomst",
    portfolios: [
      ["a0000000-0000-4000-a000-000000001101", "Rendement",               "CHE-RP", "Rendement", "EQUITIES", "AC WORLD", "EigenBeheer", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000001102", "Matching",                "CHE-MP", "Matching", "FIXED_INCOME", "SOVEREIGN EUROPE", "EigenBeheer", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000001103", "Opbouw",                  "CHE-OP", "Opbouw", "EQUITIES", "EUROPE", "ExternA", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000001104", "High yield",              "CHE-HY", "Rendement", "FIXED_INCOME", "HIGH YIELD", "ExternA", "C", "BLOOMBERG_HY"],
      ["a0000000-0000-4000-a000-000000001105", "LDI portefeuille",        "CHE-LI", "Matching", "FIXED_INCOME", "LDI", "EigenBeheer", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000001106", "Vastgoed",                "CHE-VG", "Rendement", "REAL_ASSETS", "REALESTATE LISTED", "ExternB", "A", "FTSE_EPRA"],
      ["a0000000-0000-4000-a000-000000001107", "Risk parity",             "CHE-RP2","Rendement", "ALTERNATIVES", "RISK PARITY", "ExternA", "C", "HFRX_GL"],
      ["a0000000-0000-4000-a000-000000001108", "Liquiditeiten",           "CHE-LQ", "Matching", "CASH", "CASH", "EigenBeheer", "A", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000001109", "Groene obligaties",       "CHE-GO", "Matching", "FIXED_INCOME", "GREENBONDS", "ExternB", "B", "CUSTOM_ESG"],
    ],
  },
  {
    ...
    regelingType: "pensioenuitkering",
    portfolios: [
      ["a0000000-0000-4000-a000-000000001201", "Rendementsportefeuille",  "TEC-RP", "Rendement", "EQUITIES", "AC WORLD", "EigenBeheer", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000001202", "Matchingportefeuille",    "TEC-MP", "Matching", "FIXED_INCOME", "SOVEREIGN EUROPE", "EigenBeheer", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000001203", "Opbouwportefeuille",      "TEC-OP", "Opbouw", "EQUITIES", "DEVELOPED MARKETS", "ExternA", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000001204", "VS aandelen",             "TEC-VS", "Rendement", "EQUITIES", "UNITED STATES", "ExternA", "A", "SP500"],
      ["a0000000-0000-4000-a000-000000001205", "Opkomende markten",       "TEC-OM", "Rendement", "EQUITIES", "EMERGING MARKETS", "ExternB", "C", "MSCI_EM"],
      ["a0000000-0000-4000-a000-000000001206", "Europese kredieten",      "TEC-EK", "Rendement", "FIXED_INCOME", "CREDITS EUROPE", "ExternA", "B", "ICE_BOFA"],
      ["a0000000-0000-4000-a000-000000001207", "Private equity",          "TEC-PE", "Rendement", "ALTERNATIVES", "PRIVATE EQUITY", "ExternB", "A", "RIMES_PE"],
      ["a0000000-0000-4000-a000-000000001208", "Vastgoedportefeuille",    "TEC-VP", "Rendement", "REAL_ASSETS", "REALESTATE DIRECT", "ExternA", "C", "GLOBAL_REIT"],
      ["a0000000-0000-4000-a000-000000001209", "Liquiditeiten",           "TEC-LQ", "Matching", "CASH", "CASH", "EigenBeheer", "C", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000001210", "Duurzame portefeuille",   "TEC-DP", "Rendement", "EQUITIES", "DUURZAAM", "EigenBeheer", "B", "CUSTOM_ESG"],
    ],
  },
];
...
export async function POST(request: Request) {
  ...
  try {
    ...
    captureError(error, { route: "/api/seed", method: "POST", phase: "request" });
