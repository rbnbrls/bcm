...
export async function createCustomerOnboarding(
  ...
  try {
    ...
    await reportError(error, { action: "onboarding-insert-client", userMessage: "Klant kon niet worden aangemaakt." });
  ...
  try {
    ...
    await reportError(error, { action: "onboarding-create-portfolios", userMessage: "Portfolio's konden niet worden aangemaakt." });
  ...
  try {
    ...
    await reportError(error, { action: "onboarding-save-change-request", userMessage: "De change kon niet worden opgeslagen." });
