...
export const clientConfigDataModel: readonly ClientConfigTableModel[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "sub_asset_class_code", type: "char(3)", nullable: false, key: "foreign", references: "client_config.sub_asset_class.sub_asset_class_code" },
      { name: "manager_code", type: "char(3)", nullable: false, key: "foreign", references: "client_config.manager.manager_code" },
      { name: "benchmark_code", type: "varchar(60)", nullable: false, key: "foreign", references: "client_config.benchmark.benchmark_code" },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "parent_asset_class_code", type: "char(2)", nullable: true, key: "foreign", references: "client_config.asset_class.asset_class_code" },
      { name: "sub_asset_class_code", type: "char(3)", nullable: true, key: "foreign", references: "client_config.sub_asset_class.sub_asset_class_code" },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "portfolio_code", type: "varchar(15)", nullable: false, key: "foreign", references: "client_config.portfolio.portfolio_code" },
      { name: "parent_account_code", type: "varchar(16)", nullable: true, key: "foreign", references: "client_config.parent_account.parent_account_code" },
      { name: "asset_class_code", type: "char(2)", nullable: false, key: "foreign", references: "client_config.asset_class.asset_class_code" },
      { name: "sub_asset_class_code", type: "char(3)", nullable: false, key: "foreign", references: "client_config.sub_asset_class.sub_asset_class_code" },
      { name: "manager_code", type: "char(3)", nullable: false, key: "foreign", references: "client_config.manager.manager_code" },
      { name: "benchmark_code", type: "varchar(60)", nullable: false, key: "foreign", references: "client_config.benchmark.benchmark_code" },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "parent_account_code", type: "text", nullable: true, key: "foreign", references: "client_config.parent_account.parent_account_code" },
