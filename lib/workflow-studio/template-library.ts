...
const CURATED_LIBRARY: readonly WorkflowTemplateLibraryEntry[] = Object.freeze([
  ...
  {
    id: "manager_switch.v1",
    kind: "template",
    version: 1,
    title: "Manager wissel",
    description: "Wijzig de manager van een bestaande portfolio_configuration met service-catalogusvalidatie en accountmanagerakkoord.",
    ownerUserId: "workflow-library",
    tags: Object.freeze(["change", "portfolio_configuration", "manager", "service-catalog"]),
    sampleData: Object.freeze({ primaryAccountId: "ADP*EQACX*ROB", currentManager: "ROB", requestedManager: "AIM" }),
    rating: Object.freeze({ score: 4.7, count: 4 }),
    source: Object.freeze({ kind: "builtin", id: "manager_switch" }),
    status: "curated",
  },
  {
    id: "portfolio_configuration_create.v1",
    kind: "template",
    version: 1,
    title: "Nieuwe portfolio aanvragen",
    description: "Vraag een nieuwe portfolio_configuration voor een bestaande klant aan vanuit de service catalogus.",
    ownerUserId: "workflow-library",
    tags: Object.freeze(["change", "portfolio_configuration", "create", "service-catalog"]),
    sampleData: Object.freeze({ clientCode: "ADP", portfolioCode: "ADP", assetClass: "EQ", subAssetClass: "ACX", manager: "ROB" }),
    rating: Object.freeze({ score: 4.6, count: 3 }),
    source: Object.freeze({ kind: "builtin", id: "portfolio_configuration_create" }),
    status: "curated",
  },
  {
    id: "sub_asset_class_switch.v1",
    kind: "template",
    version: 1,
    title: "Sub asset class wissel",
    description: "Wijzig de sub asset class inclusief bovenliggende asset class op een bestaande portfolio_configuration.",
    ownerUserId: "workflow-library",
    tags: Object.freeze(["change", "portfolio_configuration", "asset-class", "service-catalog"]),
    sampleData: Object.freeze({ primaryAccountId: "ADP*EQACX*ROB", requestedAssetClass: "FI", requestedSubAssetClass: "SOG" }),
    rating: Object.freeze({ score: 4.7, count: 4 }),
