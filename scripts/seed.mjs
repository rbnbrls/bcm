...
const MANAGERS = {
  "6ST": "00000003-0000-4000-a000-000000000055",
  AB: "00000003-0000-4000-a000-000000000006",
  ABD: "00000003-0000-4000-a000-000000000002",
  ACA: "00000003-0000-4000-a000-000000000003",
  ADV: "00000003-0000-4000-a000-000000000004",
  AEG: "00000003-0000-4000-a000-000000000005",
  ALL: "00000003-0000-4000-a000-000000000007",
  ALM: "00000003-0000-4000-a000-000000000008",
  AQR: "00000003-0000-4000-a000-000000000009",
  ARR: "00000003-0000-4000-a000-000000000010",
  AXA: "00000003-0000-4000-a000-000000000011",
  BAR: "00000003-0000-4000-a000-000000000012",
  BLB: "00000003-0000-4000-a000-000000000015",
  BLK: "00000003-0000-4000-a000-000000000014",
  BNP: "00000003-0000-4000-a000-000000000016",
  BRG: "00000003-0000-4000-a000-000000000013",
  BSM: "00000003-0000-4000-a000-000000000017",
  CAR: "00000003-0000-4000-a000-000000000018",
  CIT: "00000003-0000-4000-a000-000000000019",
  CTI: "00000003-0000-4000-a000-000000000020",
  DDJ: "00000003-0000-4000-a000-000000000021",
  DMF: "00000003-0000-4000-a000-000000000022",
  DWS: "00000003-0000-4000-a000-000000000023",
  DYC: "00000003-0000-4000-a000-000000000024",
  FID: "00000003-0000-4000-a000-000000000025",
  GOL: "00000003-0000-4000-a000-000000000026",
  HND: "00000003-0000-4000-a000-000000000027",
  ING: "00000003-0000-4000-a000-000000000028",
  INS: "00000003-0000-4000-a000-000000000029",
  INT: "00000003-0000-4000-a000-000000000030",
  IRL: "00000003-0000-4000-a000-000000000031",
  JPM: "00000003-0000-4000-a000-000000000032",
  KMP: "00000003-0000-4000-a000-000000000033",
  KPR: "00000003-0000-4000-a000-000000000034",
  LAZ: "00000003-0000-4000-a000-000000000035",
  LG: "00000003-0000-4000-a000-000000000036",
  LSV: "00000003-0000-4000-a000-000000000037",
  MET: "00000003-0000-4000-a000-000000000039",
  MFS: "00000003-0000-4000-a000-000000000040",
  MG: "00000003-0000-4000-a000-000000000038",
  MS: "00000003-0000-4000-a000-000000000041",
  NIN: "00000003-0000-4000-a000-000000000042",
  NOM: "00000003-0000-4000-a000-000000000043",
  NOR: "00000003-0000-4000-a000-000000000044",
  NT: "00000003-0000-4000-a000-000000000045",
  OAK: "00000003-0000-4000-a000-000000000046",
  OWN: "00000003-0000-4000-a000-000000000001",
  PAY: "00000003-0000-4000-a000-000000000047",
  PGM: "00000003-0000-4000-a000-000000000048",
  PIM: "00000003-0000-4000-a000-000000000049",
  PS: "00000003-0000-4000-a000-000000000050",
  PVF: "00000003-0000-4000-a000-000000000051",
  PZE: "00000003-0000-4000-a000-000000000052",
  ROB: "00000003-0000-4000-a000-000000000053",
  RUS: "00000003-0000-4000-a000-000000000054",
  SH: "00000003-0000-4000-a000-000000000057",
  SST: "00000003-0000-4000-a000-000000000056",
  TRO: "00000003-0000-4000-a000-000000000058",
  UBS: "00000003-0000-4000-a000-000000000059"
};
...
const clients = [
  ...
  // 3. Bedrijfstakpensioenfonds Metaal & Techniek
  {
    ...
    regelingType: "premieovereenkomst",
    portfolios: [
      ["a0000000-0000-4000-a000-000000000301", "Rendementsportefeuille", "MET-RP", "Rendement", "EQUITIES", "AC WORLD", "OWN", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000000302", "Matchingportefeuille",  "MET-MP", "Matching", "FIXED_INCOME", "SOVEREIGN EUROPE", "OWN", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000000303", "Opbouwportefeuille",    "MET-OP", "Opbouw", "EQUITIES", "DEVELOPED MARKETS", "CIT", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000000304", "Duurzame portefeuille",  "MET-DP", "Rendement", "EQUITIES", "DUURZAAM", "CTI", "C", "CUSTOM_ESG"],
      ["a0000000-0000-4000-a000-000000000305", "Vastgoedportefeuille",   "MET-VP", "Rendement", "REAL_ASSETS", "REALESTATE LISTED", "DDJ", "A", "GLOBAL_REIT"],
      ["a0000000-0000-4000-a000-000000000306", "Liquiditeiten",          "MET-LQ", "Matching", "CASH", "CASH", "OWN", "C", "MSCI_WORLD"],
    ],
  },
  ...
  // 4. Stichting Pensioenfonds Vervoer
  {
    ...
    regelingType: "pensioenuitkering",
    portfolios: [
      ["a0000000-0000-4000-a000-000000000401", "Return portefeuille",     "VRV-RET", "Rendement", "EQUITIES", "UNITED STATES", "MS", "A", "SP500"],
      ["a0000000-0000-4000-a000-000000000402", "Matching portefeuille",   "VRV-MP",  "Matching", "FIXED_INCOME", "GOVERNMENT BONDS", "OWN", "B", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000000403", "Groei portefeuille",      "VRV-GR",  "Opbouw", "EQUITIES", "EMERGING MARKETS", "NOM", "A", "MSCI_EM"],
      ["a0000000-0000-4000-a000-000000000404", "Europees krediet",        "VRV-EK",  "Rendement", "FIXED_INCOME", "CREDITS EUROPE", "NOR", "B", "ICE_BOFA"],
      ["a0000000-0000-4000-a000-000000000405", "Inflatieportefeuille",    "VRV-IP",  "Matching", "FIXED_INCOME", "INFLATION LINKED BONDS EUROPE", "OWN", "C", "BLOOMBERG_GL"],
      ["a0000000-0000-4000-a000-000000000406", "Privé-equity",           "VRV-PE",  "Rendement", "ALTERNATIVES", "PRIVATE EQUITY", "OAK", "A", "RIMES_PE"],
      ["a0000000-0000-4000-a000-000000000407", "Infrastructuur",          "VRV-IF",  "Opbouw", "REAL_ASSETS", "INFRASTRUCTURE", "PAY", "C", "WORLD_INFRA"],
    ],
  },
  ...
  // 5. Algemeen Pensioenfonds Bouw
  {
    ...
    portfolios: [
      ["a0000000-0000-4000-a000-000000000501", "Rendementsportefeuille",  "BOU-RP", "Rendement", "EQUITIES", "AC WORLD", "OWN", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000000502", "Matchingportefeuille",    "BOU-MP", "Matching", "FIXED_INCOME", "SOVEREIGN EUROPE", "OWN", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000000503", "Opbouwportefeuille",      "BOU-OP", "Opbouw", "EQUITIES", "DEVELOPED MARKETS", "AQR", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000000504", "Vastgoed fondsen",        "BOU-VF", "Rendement", "REAL_ASSETS", "REALESTATE DIRECT", "ARR", "C", "FTSE_EPRA"],
      ["a0000000-0000-4000-a000-000000000505", "Groene obligaties",       "BOU-GO", "Matching", "FIXED_INCOME", "GREENBONDS", "AXA", "B", "CUSTOM_ESG"],
      ["a0000000-0000-4000-a000-000000000506", "High yield",              "BOU-HY", "Rendement", "FIXED_INCOME", "HIGH YIELD", "BAR", "C", "BLOOMBERG_HY"],
      ["a0000000-0000-4000-a000-000000000507", "Liquiditeiten",           "BOU-LQ", "Matching", "CASH", "CASH", "OWN", "A", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000000508", "Hedge funds",             "BOU-HF", "Rendement", "ALTERNATIVES", "HEDGE FUNDS", "BLK", "C", "HFRX_GL"],
    ],
  },
  ...
  // 6. Pensioenfonds Zorg & Welzijn
  {
    ...
    regelingType: "pensioenuitkering",
    portfolios: [
      ["a0000000-0000-4000-a000-000000000601", "Renteforfait",            "ZWG-RF", "Matching", "FIXED_INCOME", "LDI", "OWN", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000000602", "Aandelen wereldwijd",     "ZWG-AW", "Rendement", "EQUITIES", "AC WORLD", "JPM", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000000603", "Opbouwportefeuille",      "ZWG-OP", "Opbouw", "EQUITIES", "EUROPE", "KMP", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000000604", "Gezondheidszorg",         "ZWG-GZ", "Rendement", "EQUITIES", "UNITED STATES", "KPR", "C", "MSCI_HEALTH"],
      ["a0000000-0000-4000-a000-000000000605", "Kredietportefeuille",     "ZWG-KP", "Rendement", "FIXED_INCOME", "CORPORATE EUROPE", "LAZ", "B", "ICE_BOFA"],
      ["a0000000-0000-4000-a000-000000000606", "Duurzame portefeuille",   "ZWG-DP", "Rendement", "EQUITIES", "DUURZAAM", "OWN", "C", "CUSTOM_ESG"],
      ["a0000000-0000-4000-a000-000000000607", "Vastgoedportefeuille",    "ZWG-VP", "Rendement", "REAL_ASSETS", "REALESTATE LISTED", "LSV", "A", "GLOBAL_REIT"],
      ["a0000000-0000-4000-a000-000000000608", "Inflatieswaps",           "ZWG-IS", "Matching", "FIXED_INCOME", "INFLATION LINKED BONDS EUROPE", "OWN", "C", "BLOOMBERG_GL"],
      ["a0000000-0000-4000-a000-000000000609", "Private Equity",          "ZWG-PE", "Rendement", "ALTERNATIVES", "PRIVATE EQUITY", "MET", "A", "RIMES_PE"],
    ],
  },
  ...
  // 7. Stichting Pensioenfonds Detailhandel
  {
    ...
    regelingType: "premieovereenkomst",
    portfolios: [
      ["a0000000-0000-4000-a000-000000000701", "Rendement",               "DET-RP", "Rendement", "EQUITIES", "AC WORLD", "OWN", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000000702", "Matching",                "DET-MP", "Matching", "FIXED_INCOME", "SOVEREIGN EUROPE", "OWN", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000000703", "Opbouw",                  "DET-OP", "Opbouw", "EQUITIES", "DEVELOPED MARKETS", "SH", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000000704", "Vastgoed",                "DET-VG", "Rendement", "REAL_ASSETS", "REALESTATE DIRECT", "TRO", "C", "FTSE_EPRA"],
      ["a0000000-0000-4000-a000-000000000705", "High yield Europa",       "DET-HY", "Rendement", "FIXED_INCOME", "HIGH YIELD EUROPE", "UBS", "B", "BLOOMBERG_HY"],
      ["a0000000-0000-4000-a000-000000000706", "Liquiditeiten",           "DET-LQ", "Matching", "CASH", "CASH", "OWN", "A", "EURO_GOVT"],
    ],
  },
  ...
  // 8. Bedrijfspensioenfonds Bakkerij
  {
    ...
    portfolios: [
      ["a0000000-0000-4000-a000-000000000801", "Rendementsportefeuille",  "BAK-RP", "Rendement", "EQUITIES", "EUROPE", "DDJ", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000000802", "Matchingportefeuille",    "BAK-MP", "Matching", "FIXED_INCOME", "GOVERNMENT BONDS", "OWN", "B", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000000803", "Groei portefeuille",      "BAK-GR", "Opbouw", "EQUITIES", "EMERGING MARKETS", "DWS", "A", "MSCI_EM"],
      ["a0000000-0000-4000-a000-000000000804", "Kredietportefeuille",     "BAK-KP", "Rendement", "FIXED_INCOME", "CORPORATE EUROPE", "DYC", "B", "ICE_BOFA"],
      ["a0000000-0000-4000-a000-000000000805", "Commoditeiten",           "BAK-CO", "Rendement", "REAL_ASSETS", "COMMODITIES", "FID", "C", "SP_GSCI"],
      ["a0000000-0000-4000-a000-000000000806", "Private equity",          "BAK-PE", "Rendement", "ALTERNATIVES", "PRIVATE EQUITY", "GOL", "A", "RIMES_PE"],
      ["a0000000-0000-4000-a000-000000000807", "Liquiditeiten",           "BAK-LQ", "Matching", "CASH", "CASH", "OWN", "C", "EURO_GOVT"],
    ],
  },
  ...
  // 9. Pensioenfonds Openbaar Vervoer
  {
    ...
    regelingType: "pensioenuitkering",
    portfolios: [
      ["a0000000-0000-4000-a000-000000000901", "Return portefeuille",     "OVV-RET", "Rendement", "EQUITIES", "AC WORLD", "NT", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000000902", "Matching portefeuille",   "OVV-MP",  "Matching", "FIXED_INCOME", "SOVEREIGN EUROPE", "OWN", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000000903", "Opbouw portefeuille",     "OVV-OP",  "Opbouw", "EQUITIES", "DEVELOPED MARKETS", "PAY", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000000904", "Duurzame portefeuille",   "OVV-DP",  "Rendement", "EQUITIES", "DUURZAAM", "OWN", "C", "CUSTOM_ESG"],
      ["a0000000-0000-4000-a000-000000000905", "Vastgoed portefeuille",   "OVV-VP",  "Rendement", "REAL_ASSETS", "REALESTATE LISTED", "PIM", "C", "GLOBAL_REIT"],
      ["a0000000-0000-4000-a000-000000000906", "Hedge fund portefeuille", "OVV-HF",  "Rendement", "ALTERNATIVES", "HEDGE FUNDS", "PS", "A", "HFRX_GL"],
      ["a0000000-0000-4000-a000-000000000907", "Inflatieportefeuille",    "OVV-IP",  "Matching", "FIXED_INCOME", "INFLATION LINKED BONDS EUROPE", "OWN", "B", "BLOOMBERG_GL"],
      ["a0000000-0000-4000-a000-000000000908", "Kortlopend",              "OVV-KL",  "Matching", "CASH", "CASH", "OWN", "C", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000000909", "Japan aandelen",          "OVV-JP",  "Rendement", "EQUITIES", "JAPAN", "ROB", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000000910", "Infrastructuur",          "OVV-IF",  "Opbouw", "REAL_ASSETS", "INFRASTRUCTURE", "ABD", "C", "WORLD_INFRA"],
    ],
  },
  ...
  // 10. Stichting Pensioenfonds Landbouw
  {
    ...
    regelingType: "kapitaalovereenkomst",
    portfolios: [
      ["a0000000-0000-4000-a000-000000001001", "Rendementsportefeuille",  "LAN-RP", "Rendement", "EQUITIES", "AC WORLD", "OWN", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000001002", "Matchingportefeuille",    "LAN-MP", "Matching", "FIXED_INCOME", "GOVERNMENT BONDS", "OWN", "B", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000001003", "Opbouwportefeuille",      "LAN-OP", "Opbouw", "EQUITIES", "DEVELOPED MARKETS", "MS", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000001004", "Agrarische portefeuille", "LAN-AP", "Rendement", "REAL_ASSETS", "AGRICULTURE", "NIN", "C", "SP_GSCI"],
      ["a0000000-0000-4000-a000-000000001005", "Duurzame portefeuille",   "LAN-DP", "Rendement", "EQUITIES", "DUURZAAM", "OWN", "C", "CUSTOM_ESG"],
      ["a0000000-0000-4000-a000-000000001006", "Krediet Europa",          "LAN-KE", "Rendement", "FIXED_INCOME", "CREDITS EUROPE", "NOR", "B", "ICE_BOFA"],
      ["a0000000-0000-4000-a000-000000001007", "Private equity",          "LAN-PE", "Rendement", "ALTERNATIVES", "PRIVATE EQUITY", "NT", "A", "RIMES_PE"],
      ["a0000000-0000-4000-a000-000000001008", "Commoditeiten",           "LAN-CO", "Rendement", "REAL_ASSETS", "COMMODITIES", "OAK", "C", "SP_GSCI"],
    ],
  },
  ...
  // 11. Algemeen Pensioenfonds Chemie
  {
    ...
    regelingType: "premieovereenkomst",
    portfolios: [
      ["a0000000-0000-4000-a000-000000001101", "Rendement",               "CHE-RP", "Rendement", "EQUITIES", "AC WORLD", "OWN", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000001102", "Matching",                "CHE-MP", "Matching", "FIXED_INCOME", "SOVEREIGN EUROPE", "OWN", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000001103", "Opbouw",                  "CHE-OP", "Opbouw", "EQUITIES", "EUROPE", "ALL", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000001104", "High yield",              "CHE-HY", "Rendement", "FIXED_INCOME", "HIGH YIELD", "ALM", "C", "BLOOMBERG_HY"],
      ["a0000000-0000-4000-a000-000000001105", "LDI portefeuille",        "CHE-LI", "Matching", "FIXED_INCOME", "LDI", "OWN", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000001106", "Vastgoed",                "CHE-VG", "Rendement", "REAL_ASSETS", "REALESTATE LISTED", "ARR", "A", "FTSE_EPRA"],
      ["a0000000-0000-4000-a000-000000001107", "Risk parity",             "CHE-RP2","Rendement", "ALTERNATIVES", "RISK PARITY", "AXA", "C", "HFRX_GL"],
      ["a0000000-0000-4000-a000-000000001108", "Liquiditeiten",           "CHE-LQ", "Matching", "CASH", "CASH", "OWN", "A", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000001109", "Groene obligaties",       "CHE-GO", "Matching", "FIXED_INCOME", "GREENBONDS", "BRG", "B", "CUSTOM_ESG"],
    ],
  },
  ...
  // 12. Pensioenfonds Techniek Nederland
  {
    ...
    regelingType: "pensioenuitkering",
    portfolios: [
      ["a0000000-0000-4000-a000-000000001201", "Rendementsportefeuille",  "TEC-RP", "Rendement", "EQUITIES", "AC WORLD", "OWN", "A", "MSCI_ACWI"],
      ["a0000000-0000-4000-a000-000000001202", "Matchingportefeuille",    "TEC-MP", "Matching", "FIXED_INCOME", "SOVEREIGN EUROPE", "OWN", "B", "BLOOMBERG_EU"],
      ["a0000000-0000-4000-a000-000000001203", "Opbouwportefeuille",      "TEC-OP", "Opbouw", "EQUITIES", "DEVELOPED MARKETS", "IRL", "A", "MSCI_WORLD"],
      ["a0000000-0000-4000-a000-000000001204", "VS aandelen",             "TEC-VS", "Rendement", "EQUITIES", "UNITED STATES", "JPM", "A", "SP500"],
      ["a0000000-0000-4000-a000-000000001205", "Opkomende markten",       "TEC-OM", "Rendement", "EQUITIES", "EMERGING MARKETS", "KMP", "C", "MSCI_EM"],
      ["a0000000-0000-4000-a000-000000001206", "Europese kredieten",      "TEC-EK", "Rendement", "FIXED_INCOME", "CREDITS EUROPE", "KPR", "B", "ICE_BOFA"],
      ["a0000000-0000-4000-a000-000000001207", "Private equity",          "TEC-PE", "Rendement", "ALTERNATIVES", "PRIVATE EQUITY", "LAZ", "A", "RIMES_PE"],
      ["a0000000-0000-4000-a000-000000001208", "Vastgoedportefeuille",    "TEC-VP", "Rendement", "REAL_ASSETS", "REALESTATE DIRECT", "LG", "C", "GLOBAL_REIT"],
      ["a0000000-0000-4000-a000-000000001209", "Liquiditeiten",           "TEC-LQ", "Matching", "CASH", "CASH", "OWN", "C", "EURO_GOVT"],
      ["a0000000-0000-4000-a000-000000001210", "Duurzame portefeuille",   "TEC-DP", "Rendement", "EQUITIES", "DUURZAAM", "OWN", "B", "CUSTOM_ESG"],
    ],
  },
];
