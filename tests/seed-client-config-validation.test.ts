 ...
 */
const SEED_MANAGERS = VALID_MANAGERS.map((manager, index) => ({
  managerId: index + 1,
...
const SEED_PORTFOLIO_CONFIGURATIONS = [
  ...
  { portfolioCode: "ZEKRET", assetClassCode: "EQ", subAssetClassCode: "DEV", managerCode: "ROB", benchmarkCode: "MSCI-ACWI-NR", npcClassificationId: 2, longName: "Zeker Returnportefeuille Ontwikkelde Markten", shortName: "ZEK EQ DEV", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "METOP", assetClassCode: "EQ", subAssetClassCode: "DEV", managerCode: "ROB", benchmarkCode: "MSCI-ACWI-NR", npcClassificationId: 3, longName: "Metaal Opbouwportefeuille Ontwikkelde Markten", shortName: "MET EQ DEV", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "METDP", assetClassCode: "EQ", subAssetClassCode: "DUU", managerCode: "BLK", benchmarkCode: "CUSTOM-ESG-NL", npcClassificationId: 2, longName: "Metaal Duurzame Portefeuille Duurzaam", shortName: "MET EQ DUU", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "METVP", assetClassCode: "RA", subAssetClassCode: "REA", managerCode: "ROB", benchmarkCode: "GLOBAL-REIT-NR", npcClassificationId: 2, longName: "Metaal Vastgoedportefeuille REITs", shortName: "MET RA REA", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "VRVRET", assetClassCode: "EQ", subAssetClassCode: "UNI", managerCode: "ROB", benchmarkCode: "S&P-500-NR", npcClassificationId: 2, longName: "Vervoer Returnportefeuille Verenigde Staten", shortName: "VRV EQ UNI", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "VRVGR", assetClassCode: "EQ", subAssetClassCode: "EME", managerCode: "ROB", benchmarkCode: "MSCI-EM-NR", npcClassificationId: 3, longName: "Vervoer Groeiportefeuille Opkomende Markten", shortName: "VRV EQ EME", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "VRVEK", assetClassCode: "FI", subAssetClassCode: "CRE", managerCode: "BLK", benchmarkCode: "ICE-BOFA-EU-CORP", npcClassificationId: 2, longName: "Vervoer Europees Krediet Credits Europa", shortName: "VRV FI CRE", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "VRVPE", assetClassCode: "AL", subAssetClassCode: "PRI", managerCode: "ROB", benchmarkCode: "RIMES-PRIVATE-EQ", npcClassificationId: 2, longName: "Vervoer Private Equity", shortName: "VRV AL PRI", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "VRVIF", assetClassCode: "RA", subAssetClassCode: "INF", managerCode: "BLK", benchmarkCode: "MSCI-WORLD-INFRA", npcClassificationId: 3, longName: "Vervoer Infrastructuur", shortName: "VRV RA INF", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "BOUOP", assetClassCode: "EQ", subAssetClassCode: "DEV", managerCode: "ROB", benchmarkCode: "MSCI-ACWI-NR", npcClassificationId: 3, longName: "Bouw Opbouwportefeuille Ontwikkelde Markten", shortName: "BOU EQ DEV", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "BOUVF", assetClassCode: "RA", subAssetClassCode: "RED", managerCode: "BLK", benchmarkCode: "FTSE-EPRA-NAREIT-DEV", npcClassificationId: 2, longName: "Bouw Vastgoedfondsen Direct Vastgoed", shortName: "BOU RA RED", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "BOUGO", assetClassCode: "FI", subAssetClassCode: "GRE", managerCode: "ROB", benchmarkCode: "CUSTOM-ESG-NL", npcClassificationId: 1, longName: "Bouw Groene Obligaties Greenbonds", shortName: "BOU FI GRE", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "BOUHY", assetClassCode: "FI", subAssetClassCode: "HYG", managerCode: "BLK", benchmarkCode: "BLOOMBERG-GL-HY", npcClassificationId: 2, longName: "Bouw High Yield Global", shortName: "BOU FI HYG", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "BOUHF", assetClassCode: "AL", subAssetClassCode: "HED", managerCode: "ROB", benchmarkCode: "HFRX-GL-HEDGE", npcClassificationId: 2, longName: "Bouw Hedge Funds", shortName: "BOU AL HED", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "ZWGAW", assetClassCode: "EQ", subAssetClassCode: "ACX", managerCode: "ROB", benchmarkCode: "MSCI-WORLD-NR", npcClassificationId: 2, longName: "Zorg Aandelen Wereldwijd AC World", shortName: "ZWG EQ ACX", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "ZWGOP", assetClassCode: "EQ", subAssetClassCode: "EUR", managerCode: "ROB", benchmarkCode: "MSCI-ACWI-NR", npcClassificationId: 3, longName: "Zorg Opbouwportefeuille Europa", shortName: "ZWG EQ EUR", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "ZWGGZ", assetClassCode: "EQ", subAssetClassCode: "UNI", managerCode: "BLK", benchmarkCode: "MSCI-WORLD-HEALTH", npcClassificationId: 2, longName: "Zorg Gezondheidszorg Verenigde Staten", shortName: "ZWG EQ UNI", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "ZWGKP", assetClassCode: "FI", subAssetClassCode: "COR", managerCode: "ROB", benchmarkCode: "ICE-BOFA-EU-CORP", npcClassificationId: 2, longName: "Zorg Kredietportefeuille Corporates Europa", shortName: "ZWG FI COR", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "ZWGVP", assetClassCode: "RA", subAssetClassCode: "REA", managerCode: "BLK", benchmarkCode: "GLOBAL-REIT-NR", npcClassificationId: 2, longName: "Zorg Vastgoedportefeuille REITs", shortName: "ZWG RA REA", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "ZWGPE", assetClassCode: "AL", subAssetClassCode: "PRI", managerCode: "ROB", benchmarkCode: "RIMES-PRIVATE-EQ", npcClassificationId: 2, longName: "Zorg Private Equity", shortName: "ZWG AL PRI", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "DETOP", assetClassCode: "EQ", subAssetClassCode: "DEV", managerCode: "ROB", benchmarkCode: "MSCI-ACWI-NR", npcClassificationId: 3, longName: "Detailhandel Opbouw Ontwikkelde Markten", shortName: "DET EQ DEV", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "DETVG", assetClassCode: "RA", subAssetClassCode: "RED", managerCode: "BLK", benchmarkCode: "FTSE-EPRA-NAREIT-DEV", npcClassificationId: 2, longName: "Detailhandel Vastgoed Direct", shortName: "DET RA RED", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "DETHY", assetClassCode: "FI", subAssetClassCode: "HYE", managerCode: "ROB", benchmarkCode: "BLOOMBERG-GL-HY", npcClassificationId: 2, longName: "Detailhandel High Yield Europa", shortName: "DET FI HYE", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "BAKRP", assetClassCode: "EQ", subAssetClassCode: "EUR", managerCode: "ROB", benchmarkCode: "MSCI-WORLD-NR", npcClassificationId: 2, longName: "Bakkerij Rendementsportefeuille Europa", shortName: "BAK EQ EUR", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "BAKGR", assetClassCode: "EQ", subAssetClassCode: "EME", managerCode: "ROB", benchmarkCode: "MSCI-EM-NR", npcClassificationId: 3, longName: "Bakkerij Groei Opkomende Markten", shortName: "BAK EQ EME", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "BAKKP", assetClassCode: "FI", subAssetClassCode: "COR", managerCode: "BLK", benchmarkCode: "ICE-BOFA-EU-CORP", npcClassificationId: 2, longName: "Bakkerij Kredietportefeuille Corporates", shortName: "BAK FI COR", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "BAKCO", assetClassCode: "RA", subAssetClassCode: "COM", managerCode: "ROB", benchmarkCode: "S&P-GSCI", npcClassificationId: 2, longName: "Bakkerij Commoditeiten", shortName: "BAK RA COM", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "BAKPE", assetClassCode: "AL", subAssetClassCode: "PRI", managerCode: "BLK", benchmarkCode: "RIMES-PRIVATE-EQ", npcClassificationId: 2, longName: "Bakkerij Private Equity", shortName: "BAK AL PRI", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "OVVRET", assetClassCode: "EQ", subAssetClassCode: "ACX", managerCode: "ROB", benchmarkCode: "MSCI-ACWI-NR", npcClassificationId: 2, longName: "OVV Returnportefeuille AC World", shortName: "OVV EQ ACX", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "OVVOP", assetClassCode: "EQ", subAssetClassCode: "DEV", managerCode: "ROB", benchmarkCode: "MSCI-WORLD-NR", npcClassificationId: 3, longName: "OVV Opbouwportefeuille Ontwikkelde Markten", shortName: "OVV EQ DEV", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "OVVVP", assetClassCode: "RA", subAssetClassCode: "REA", managerCode: "BLK", benchmarkCode: "GLOBAL-REIT-NR", npcClassificationId: 2, longName: "OVV Vastgoedportefeuille REITs", shortName: "OVV RA REA", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "OVVHF", assetClassCode: "AL", subAssetClassCode: "HED", managerCode: "ROB", benchmarkCode: "HFRX-GL-HEDGE", npcClassificationId: 2, longName: "OVV Hedge Fund Portefeuille", shortName: "OVV AL HED", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "OVVJP", assetClassCode: "EQ", subAssetClassCode: "JAP", managerCode: "BLK", benchmarkCode: "MSCI-WORLD-NR", npcClassificationId: 2, longName: "OVV Japan Aandelen", shortName: "OVV EQ JAP", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "OVVIF", assetClassCode: "RA", subAssetClassCode: "INF", managerCode: "ROB", benchmarkCode: "MSCI-WORLD-INFRA", npcClassificationId: 3, longName: "OVV Infrastructuur", shortName: "OVV RA INF", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "LANOP", assetClassCode: "EQ", subAssetClassCode: "DEV", managerCode: "ROB", benchmarkCode: "MSCI-ACWI-NR", npcClassificationId: 3, longName: "Landbouw Opbouwportefeuille Ontwikkelde Markten", shortName: "LAN EQ DEV", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "LANAP", assetClassCode: "RA", subAssetClassCode: "AGR", managerCode: "BLK", benchmarkCode: "S&P-GSCI", npcClassificationId: 2, longName: "Landbouw Agrarische Portefeuille", shortName: "LAN RA AGR", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "LANKE", assetClassCode: "FI", subAssetClassCode: "CRE", managerCode: "ROB", benchmarkCode: "ICE-BOFA-EU-CORP", npcClassificationId: 2, longName: "Landbouw Krediet Europa", shortName: "LAN FI CRE", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "LANPE", assetClassCode: "AL", subAssetClassCode: "PRI", managerCode: "BLK", benchmarkCode: "RIMES-PRIVATE-EQ", npcClassificationId: 2, longName: "Landbouw Private Equity", shortName: "LAN AL PRI", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "LANCO", assetClassCode: "RA", subAssetClassCode: "COM", managerCode: "ROB", benchmarkCode: "S&P-GSCI", npcClassificationId: 2, longName: "Landbouw Commoditeiten", shortName: "LAN RA COM", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "CHEOP", assetClassCode: "EQ", subAssetClassCode: "EUR", managerCode: "ROB", benchmarkCode: "MSCI-ACWI-NR", npcClassificationId: 3, longName: "Chemie Opbouw Europa", shortName: "CHE EQ EUR", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "CHEHY", assetClassCode: "FI", subAssetClassCode: "HYG", managerCode: "ROB", benchmarkCode: "BLOOMBERG-GL-HY", npcClassificationId: 2, longName: "Chemie High Yield Global", shortName: "CHE FI HYG", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "CHEVG", assetClassCode: "RA", subAssetClassCode: "REA", managerCode: "BLK", benchmarkCode: "FTSE-EPRA-NAREIT-DEV", npcClassificationId: 2, longName: "Chemie Vastgoed REITs", shortName: "CHE RA REA", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "CHERP2", assetClassCode: "AL", subAssetClassCode: "RIS", managerCode: "ROB", benchmarkCode: "HFRX-GL-HEDGE", npcClassificationId: 2, longName: "Chemie Risk Parity", shortName: "CHE AL RIS", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "CHEGO", assetClassCode: "FI", subAssetClassCode: "GRE", managerCode: "BLK", benchmarkCode: "CUSTOM-ESG-NL", npcClassificationId: 1, longName: "Chemie Groene Obligaties", shortName: "CHE FI GRE", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  ...
  { portfolioCode: "TECOP", assetClassCode: "EQ", subAssetClassCode: "DEV", managerCode: "ROB", benchmarkCode: "MSCI-WORLD-NR", npcClassificationId: 3, longName: "Techniek Opbouwportefeuille Ontwikkelde Markten", shortName: "TEC EQ DEV", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "TECVS", assetClassCode: "EQ", subAssetClassCode: "UNI", managerCode: "ROB", benchmarkCode: "S&P-500-NR", npcClassificationId: 2, longName: "Techniek VS Aandelen", shortName: "TEC EQ UNI", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "TECOM", assetClassCode: "EQ", subAssetClassCode: "EME", managerCode: "BLK", benchmarkCode: "MSCI-EM-NR", npcClassificationId: 2, longName: "Techniek Opkomende Markten", shortName: "TEC EQ EME", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "TECEK", assetClassCode: "FI", subAssetClassCode: "CRE", managerCode: "ROB", benchmarkCode: "ICE-BOFA-EU-CORP", npcClassificationId: 2, longName: "Techniek Europese Kredieten", shortName: "TEC FI CRE", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "TECPE", assetClassCode: "AL", subAssetClassCode: "PRI", managerCode: "BLK", benchmarkCode: "RIMES-PRIVATE-EQ", npcClassificationId: 2, longName: "Techniek Private Equity", shortName: "TEC AL PRI", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
  { portfolioCode: "TECVP", assetClassCode: "RA", subAssetClassCode: "RED", managerCode: "ROB", benchmarkCode: "GLOBAL-REIT-NR", npcClassificationId: 2, longName: "Techniek Vastgoedportefeuille Direct", shortName: "TEC RA RED", activeInd: true, effectiveFrom: "2024-01-01", effectiveUntil: null },
...
describe("Seed managers — schema validation", () => {
  ...
  it("contains the normalized unique manager seed catalog", () => {
    expect(SEED_MANAGERS).toHaveLength(59);
    expect(new Set(SEED_MANAGERS.map((m) => m.managerCode)).size).toBe(59);
    expect(new Set(SEED_MANAGERS.map((m) => m.managerName)).size).toBe(59);
    expect(SEED_MANAGERS.filter((m) => m.managerName === "BLACKROCK")).toHaveLength(1);
  });
});
